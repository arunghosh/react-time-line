...
var _TimlineItem = __webpack_require__(142);

var _TimlineItem2 = _interopRequireDefault(_TimlineItem);
...
function getFormattedData(items) {
  ...
  items.forEach(function (_ref, index) {
    ...
    var date = (0, _moment2.default)(ts);
    var dateStr = date.format('DD MMM YYYY');
    var list = activities[dateStr] || [];
    list.push({
...
function Timeline(_ref2) {
  var items = _ref2.items;

  var activities = getFormattedData(items);
  ...
  return _react2.default.createElement(
    ...
    dates.map(function (d) {
      return _react2.default.createElement(
        ...
        activities[d].map(function (_ref3) {
          var time = _ref3.time,
              text = _ref3.text,
              key = _ref3.key;
          return _react2.default.createElement(_TimlineItem2.default, { time: time, text: text, key: key });
        })
      );
    })
  );
...
Timeline.propTypes = {
  items: _propTypes2.default.arrayOf(_propTypes2.default.shape({
    ts: _propTypes2.default.string.isRequired,
...
var ReactPureComponent = __webpack_require__(160);
...
var stylesInDom = {},
	...
	fixUrls = __webpack_require__(166);
